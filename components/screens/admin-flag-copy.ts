...
export const FLAG_COPY: Record<FlagKey, { title: string; desc: string }> = {
  ...
  semanticSearch: { title: "Semantic search", desc: "AI-powered semantic search across directory listings." },
  aiConcierge: { title: "AI concierge", desc: "The AI concierge for halal-directory questions surfaced to visitors." },
