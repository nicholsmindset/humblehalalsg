...
export function AdminScreen({ halalVerdictsEnabled = false, leadRoutingEnabled = false, passportEnabled = false }: { halalVerdictsEnabled?: boolean; leadRoutingEnabled?: boolean; passportEnabled?: boolean }) {
