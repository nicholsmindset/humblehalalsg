  ...
  return (
    <div className="stack g16" style={{ maxWidth: 720 }}>
      ...
      <div className="card" style={{ padding: 18 }}><h3>Event details</h3><div className="grid-2 g12" style={{ marginTop: 14 }}>
        <div className="field" style={{ gridColumn: "1 / -1" }}><label htmlFor="evt-title">Event title</label><input id="evt-title" className="input" value={form.title} onChange={(e) => set("title", e.target.value)} /></div>
        <div className="field"><label htmlFor="evt-category">Category</label><input id="evt-category" className="input" value={form.cat} onChange={(e) => set("cat", e.target.value)} /></div>
        <div className="field"><label htmlFor="evt-capacity">Capacity (0 = unlimited)</label><input id="evt-capacity" className="input" type="number" min={0} value={form.capacity} onChange={(e) => set("capacity", e.target.value)} /></div>
        <div className="field" style={{ gridColumn: "1 / -1" }}><label htmlFor="evt-description">Description</label><textarea id="evt-description" className="input" rows={5} value={form.blurb} onChange={(e) => set("blurb", e.target.value)} /></div>
      </div></div>
      <div className="card" style={{ padding: 18 }}><h3>Date &amp; location</h3><div className="grid-2 g12" style={{ marginTop: 14 }}>
        <div className="field"><label htmlFor="evt-date">Date</label><input id="evt-date" className="input" type="date" value={form.date_iso.slice(0, 10)} onChange={(e) => set("date_iso", e.target.value)} /></div>
        <div className="field"><label htmlFor="evt-date-label">Date label</label><input id="evt-date-label" className="input" placeholder="Sat, 20 July" value={form.dateLabel} onChange={(e) => set("dateLabel", e.target.value)} /></div>
        <div className="field"><label htmlFor="evt-start-time">Start time</label><input id="evt-start-time" className="input" placeholder="e.g. 7:00 PM" value={form.timeLabel} onChange={(e) => set("timeLabel", e.target.value)} /></div>
        <div className="field"><label htmlFor="evt-end-time">End time</label><input id="evt-end-time" className="input" placeholder="e.g. 9:30 PM" value={form.endTime} onChange={(e) => set("endTime", e.target.value)} /></div>
        <div className="field"><label htmlFor="evt-venue">Venue</label><input id="evt-venue" className="input" value={form.venue} onChange={(e) => set("venue", e.target.value)} /></div>
        <div className="field"><label htmlFor="evt-area">Area</label><input id="evt-area" className="input" value={form.area} onChange={(e) => set("area", e.target.value)} /></div>
      </div></div>
      ...
      <div className="card" style={{ padding: 18 }}><h3>Tickets &amp; attendance</h3><div className="grid-2 g12" style={{ marginTop: 14 }}>
        ...
        {!form.is_free && <div className="field"><label htmlFor="evt-price-from">Starting price (SGD)</label><input id="evt-price-from" className="input" type="number" min={0} step="0.01" value={form.priceFrom} onChange={(e) => set("priceFrom", e.target.value)} /></div>}
      ...
      <div className="card" style={{ padding: 18 }}><h3>Muslim-friendly arrangements</h3><div className="grid-2 g12" style={{ marginTop: 14 }}>
        ...
        <div className="field"><label htmlFor="evt-gender">Gender arrangement</label><select id="evt-gender" className="input" value={form.genderArrangement} onChange={(e) => set("genderArrangement", e.target.value)}><option value="mixed">Mixed</option><option value="segregated">Segregated</option><option value="sisters">Sisters only</option><option value="brothers">Brothers only</option></select></div>
        <div className="field"><label htmlFor="evt-prayer-note">Prayer note</label><input id="evt-prayer-note" className="input" value={form.prayerSlotNote} onChange={(e) => set("prayerSlotNote", e.target.value)} /></div>
        <div className="field"><label htmlFor="evt-seating-note">Seating note</label><input id="evt-seating-note" className="input" value={form.seatingNote} onChange={(e) => set("seatingNote", e.target.value)} /></div>
        <div className="field"><label htmlFor="evt-refund-policy">Refund policy</label><input id="evt-refund-policy" className="input" value={form.refundPolicy} onChange={(e) => set("refundPolicy", e.target.value)} /></div>
      </div></div>
