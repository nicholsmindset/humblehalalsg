...
const META: Record<string, BlogMeta> = {
  ...
  "ramadan-singapore-2026-guide": { category: "seasonal-events", image: "/blog/ramadan-singapore-2026-guide.webp", imageAlt: "Iftar spread of dates, soup, rice and grilled chicken at sunset in a Singapore home" },
  ...
  "malay-wedding-cost-singapore": { category: "community-business", image: "/blog/malay-wedding-cost-singapore.webp", imageAlt: "Malay wedding budget planning with songket, rings, flowers, stationery and a calculator", leadVertical: "weddings" },
  "halal-food-johor-bahru-guide": { category: "muslim-travel", image: "/blog/halal-food-johor-bahru-guide.webp", imageAlt: "Johor Bahru food spread of nasi campur, grilled chicken, roti canai and teh tarik" },
  "crossing-to-johor-bahru-checkpoints-transport": { category: "muslim-travel", image: "/blog/crossing-to-johor-bahru-checkpoints-transport.webp", imageAlt: "Backpack, passport, transit card, car key and phone map at the Singapore–Johor checkpoint" },
  "umrah-from-singapore-guide": { category: "muslim-travel", image: "/blog/umrah-from-singapore-guide.webp", imageAlt: "Open travel bag with white garments, passport, sandals, dates and water for an Umrah journey" },
  "halal-mala-singapore": { category: "cuisines", image: "/blog/halal-mala-singapore.webp", imageAlt: "Halal mala xiang guo with beef, lotus root, mushrooms, tofu, greens and dried chillies" },
  "halal-mookata-singapore": { category: "cuisines", image: "/blog/halal-mookata-singapore.webp", imageAlt: "Thai mookata grill with chicken, beef, prawns, vegetables and noodles" },
  "halal-korean-bbq-singapore": { category: "cuisines", image: "/blog/halal-korean-bbq-singapore.webp", imageAlt: "Korean barbecue grill with beef short ribs, chicken, kimchi, lettuce and banchan" },
  "halal-western-food-singapore": { category: "cuisines", image: "/blog/halal-western-food-singapore.webp", imageAlt: "Halal Western spread of grilled steak, beef burger, pasta, vegetables and brunch sides" },
  "is-it-halal-popular-chains-singapore": { category: "halal-questions", image: "/blog/is-it-halal-popular-chains-singapore.webp", imageAlt: "Unbranded takeaway boxes beside a phone checklist and magnifying glass for checking halal status" },
  "is-it-halal-bakeries-cafes-singapore": { category: "halal-questions", image: "/blog/is-it-halal-bakeries-cafes-singapore.webp", imageAlt: "Croissants, artisan bread, fruit tart and coffee beside a phone used to check halal status" },
  "aqiqah-singapore-guide": { category: "muslim-services", image: "/blog/aqiqah-singapore-guide.webp", imageAlt: "Baby booties, folded blanket, wooden lamb, dates and blank invitation for an aqiqah" },
};
