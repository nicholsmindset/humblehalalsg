/* Humble Halal — shared branded email layout. Email-safe (table-based, inline
   styles, no external CSS/JS) so it renders in Gmail, Apple Mail, Outlook. Every
   transactional email is built from emailLayout() for one consistent look. */
...
export const p = (html: string) => `<p style="margin:0 0 16px;font-size:16px;line-height:1.6;color:${INK};">${html}</p>`;
...
<tr><td align="center">
  <table role="presentation" width="600" cellpadding="0" cellspacing="0" style="max-width:600px;width:100%;">
    ...
    <tr><td style="background:${EMERALD};border-radius:14px 14px 0 0;padding:22px 28px;">
      ...
      <div style="color:#cfe3d7;font-size:12px;margin-top:2px;">${esc(SITE.tagline)}</div>
    </td></tr>
    <!-- content -->
