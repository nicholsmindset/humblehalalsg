...
export const ADDITIVES: Additive[] = [
  // ── Colours ──────────────────────────────────────────────────────────────
  {
    code: "E100", name: "Curcumin", category: "Colour", status: "halal",
    origin: "Yellow colour from turmeric root — plant-derived.",
    aliases: ["turmeric", "curcumin", "e100"],
    insNumber: "100",
    alternativeNames: ["Curcumin", "Turmeric colour", "CI Natural Yellow 3"],
    fn: "Colour (yellow)",
    confidence: "high",
    originType: "plant",
    originSummary: "E100 (Curcumin) is a yellow colour extracted from the turmeric root — a plant source — so it is generally considered halal.",
    description: "Curcumin is the natural yellow colour found in turmeric root. It is used to colour foods a warm yellow-orange and is one of the common natural, plant-based colours.",
    manufacturingSummary: "Extracted from dried turmeric rhizomes with solvents, then purified. The colour is plant-derived; any solvent carrier should be food-grade.",
    halalReasoning: "Curcumin is extracted from a plant (turmeric) with no animal-derived material, so it is generally classified as halal. As always, the finished product still needs its own verification, and where a liquid colour preparation is used its carrier should be food-grade.",
    verificationAdvice: "Curcumin itself is a halal, plant-based colour; still confirm the whole product and its certification, and check any liquid-colour carrier is not alcohol-based if that matters to you.",
    commonUses: ["Curries, sauces and mustards", "Cheese and dairy", "Baked goods and confectionery", "Soft drinks and pickles"],
    labelNames: ["Curcumin", "Turmeric", "E100", "Colour (E100)"],
    ...
    faqs: [
      { q: "Is E100 (curcumin) halal?", a: "Yes — it is a yellow colour extracted from turmeric (a plant) with no animal-derived material, so it is generally considered halal. The finished product still needs verification." },
      { q: "Is curcumin the same as turmeric?", a: "Curcumin is the main colour compound in turmeric; E100 is extracted from turmeric root." },
      { q: "What names should I look for?", a: "'Curcumin', 'Turmeric' or 'E100'." },
    ],
    relatedCodes: ["E160b", "E160c", "E162", "E101"],
    sources: [efsaTopic("Re-evaluation of curcumin (E 100) as a food additive", "Plant (turmeric) origin"), codexGsfa(), muisSource()],
  ...
  {
    code: "E160b", name: "Annatto", category: "Colour", status: "halal",
    origin: "Orange colour from annatto seeds — plant-derived.",
    aliases: ["annatto", "e160b", "bixin", "norbixin", "achiote"],
    insNumber: "160b",
    alternativeNames: ["Annatto", "Bixin", "Norbixin", "Achiote", "CI Natural Orange 4"],
    fn: "Colour (orange-yellow)",
    confidence: "high",
    originType: "plant",
    originSummary: "E160b (Annatto) is an orange-yellow colour extracted from annatto (achiote) seeds — a plant source — so it is generally considered halal.",
    description: "Annatto is a natural orange-to-yellow colour extracted from the seeds of the achiote tree. It is widely used to colour cheese, butter, snacks and cereals.",
    manufacturingSummary: "Extracted from annatto seeds (bixin/norbixin) using oil, water or solvents, then purified. The colour is plant-derived.",
    halalReasoning: "Annatto is extracted from a plant seed with no animal-derived material, so it is generally classified as halal. As always, the finished product still needs its own verification, and where a liquid preparation is used its carrier should be food-grade.",
    verificationAdvice: "Annatto itself is a halal, plant-based colour; still confirm the whole product and its certification for a finished item.",
    commonUses: ["Cheese and butter", "Snacks and cereals", "Smoked fish and sauces", "Baked goods"],
    labelNames: ["Annatto", "Bixin", "Norbixin", "E160b", "Colour (E160b)"],
    singaporeGuidance: "Ingredient guidance is not certification. Verify the finished product on the MUIS HalalSG register or with the manufacturer.",
    faqs: [
      { q: "Is E160b (annatto) halal?", a: "Yes — it is an orange colour extracted from annatto seeds (a plant) with no animal-derived material, so it is generally considered halal. The finished product still needs verification." },
      { q: "Is annatto from animals?", a: "No. It is extracted from the seeds of the achiote plant." },
      { q: "What names should I look for?", a: "'Annatto', 'Bixin', 'Norbixin' or 'E160b'." },
    ],
    relatedCodes: ["E100", "E160c", "E162", "E160a"],
    sources: [efsaTopic("Re-evaluation of annatto (E 160b) as a food additive", "Plant (annatto seed) origin"), codexGsfa(), muisSource()],
    lastReviewed: REVIEWED,
  },
  { code: "E160c", name: "Paprika extract", category: "Colour", status: "halal", origin: "From paprika/peppers — plant-derived." },
  {
    code: "E162", name: "Beetroot Red (Betanin)", category: "Colour", status: "halal",
    origin: "Red colour from beetroot — plant-derived.",
    aliases: ["betanin", "beetroot red", "e162", "beet red"],
    insNumber: "162",
    alternativeNames: ["Beetroot Red", "Betanin", "Beet Red"],
    fn: "Colour (red-pink)",
    confidence: "high",
    originType: "plant",
    originSummary: "E162 (Beetroot Red / Betanin) is a red-pink colour extracted from beetroot — a plant source — so it is generally considered halal, and is a common halal alternative to carmine.",
    description: "Beetroot red is a natural red-to-pink colour extracted from beetroot. It is used to colour foods such as desserts, sweets and dairy, and is a common plant-based alternative to insect-derived carmine (E120).",
    manufacturingSummary: "Extracted from beetroot juice and concentrated. The colour is plant-derived.",
    halalReasoning: "Beetroot red is extracted from a plant with no animal-derived material, so it is generally classified as halal. It is a common halal, plant-based alternative to carmine (E120). As always, the finished product still needs its own verification.",
    verificationAdvice: "Beetroot red itself is a halal, plant-based colour; still confirm the whole product and its certification for a finished item.",
    commonUses: ["Yoghurts and dairy desserts", "Sweets and ice cream", "Sauces and dressings", "Baked goods"],
    labelNames: ["Beetroot Red", "Betanin", "Beet Red", "E162", "Colour (E162)"],
    singaporeGuidance: "Ingredient guidance is not certification. Verify the finished product on the MUIS HalalSG register or with the manufacturer.",
    faqs: [
      { q: "Is E162 (beetroot red) halal?", a: "Yes — it is a red colour extracted from beetroot (a plant) with no animal-derived material, so it is generally considered halal. It is a common halal alternative to carmine." },
      { q: "Is beetroot red the same as carmine?", a: "No. Carmine (E120) is insect-derived; beetroot red (E162) is plant-based and is often used as a halal substitute." },
      { q: "What names should I look for?", a: "'Beetroot Red', 'Betanin', 'Beet Red' or 'E162'." },
    ],
    relatedCodes: ["E163", "E120", "E100", "E160b"],
    sources: [efsaTopic("Re-evaluation of beetroot red (E 162) as a food additive", "Plant (beetroot) origin"), codexGsfa(), muisSource()],
    lastReviewed: REVIEWED,
  },
  ...
  {
    code: "E171", name: "Titanium dioxide", category: "Colour", status: "halal",
    origin: "White mineral pigment.",
    note: "Banned as a food additive in some countries for safety reasons — that is separate from its halal status.",
    aliases: ["titanium dioxide", "e171", "tio2", "ci 77891"],
    insNumber: "171",
    alternativeNames: ["Titanium dioxide", "TiO2", "CI 77891", "CI Pigment White 6"],
    fn: "Colour (white)",
    confidence: "high",
    originType: "mineral",
    originSummary: "E171 (Titanium dioxide) is a white mineral pigment with no animal origin, so it is generally considered halal at ingredient level — though it has been restricted for safety reasons in some markets.",
    description: "Titanium dioxide is a bright white mineral pigment used to whiten and add opacity to foods such as icings, sweets and coatings, and to some medicines. Its halal status and its food-safety status are separate questions.",
    manufacturingSummary: "Produced from titanium-bearing minerals and purified to food grade. No animal-derived material.",
    halalReasoning: "Titanium dioxide is a mineral pigment with no animal or alcohol component, so at ingredient level it is generally classified as halal. Separately, some regulators have restricted or banned it in food on safety grounds — that is a food-safety matter, not a halal ruling.",
    verificationAdvice: "Titanium dioxide itself is a mineral and halal at ingredient level; still confirm the whole product and its certification. Note that some markets no longer permit it in food.",
    commonUses: ["Icings, coatings and sweets", "Chewing gum", "Some supplements and tablets", "Sauces and dressings (as a whitener)"],
    labelNames: ["Titanium dioxide", "E171", "TiO2", "Colour (E171)"],
    singaporeGuidance: "Ingredient guidance is not certification. Verify the finished product on the MUIS HalalSG register or with the manufacturer.",
    healthSummary: "Halal does not automatically mean healthy, and a health concern does not automatically make an ingredient haram. Titanium dioxide (E171) has been reviewed for safety, and some jurisdictions (notably the EU) have banned it as a food additive; other regulators still permit it. This is a food-safety matter, separate from its halal status.",
    regulatorySummary: "Banned as a food additive in the EU (from 2022) on safety grounds, while still permitted in a number of other markets. This is separate from halal classification.",
    faqs: [
      { q: "Is E171 (titanium dioxide) halal?", a: "It is a white mineral pigment with no animal origin, so at ingredient level it is generally considered halal. Its food-safety status (some bans) is a separate question." },
      { q: "Is titanium dioxide banned?", a: "It is banned as a food additive in the EU (from 2022) on safety grounds, while still permitted in some other markets — a safety matter, separate from halal status." },
      { q: "What names should I look for?", a: "'Titanium dioxide', 'E171' or 'TiO2'." },
    ],
    relatedCodes: ["E170", "E172", "E100"],
    sources: [efsaTopic("Safety assessment of titanium dioxide (E 171) as a food additive", "Mineral origin and EU safety decision"), codexGsfa(), muisSource()],
    lastReviewed: REVIEWED,
  },
  ...
  // ── Preservatives ────────────────────────────────────────────────────────
  {
    code: "E200", name: "Sorbic acid", category: "Preservative", status: "halal",
    origin: "Synthetic preservative.",
    aliases: ["sorbic acid", "e200"],
    insNumber: "200",
    alternativeNames: ["Sorbic acid", "2,4-hexadienoic acid"],
    fn: "Preservative",
    confidence: "high",
    originType: "synthetic",
    originSummary: "E200 (Sorbic acid) is a synthetically-manufactured preservative with no animal origin, so it is generally considered halal.",
    description: "Sorbic acid is a preservative that stops the growth of mould and yeast. Commercial sorbic acid is manufactured synthetically and used across many foods and drinks.",
    manufacturingSummary: "Produced by chemical synthesis. No animal-derived raw materials.",
    halalReasoning: "Sorbic acid is a synthetic preservative with no animal or alcohol component, so it is generally classified as halal. As always, the finished product still needs its own verification.",
    verificationAdvice: "Sorbic acid itself is halal; still confirm the whole product and its certification for a finished item.",
    commonUses: ["Cheese and dairy products", "Baked goods", "Dried fruit and sauces", "Soft drinks and syrups"],
    labelNames: ["Sorbic acid", "E200", "Preservative (E200)"],
    singaporeGuidance: "Ingredient guidance is not certification. Verify the finished product on the MUIS HalalSG register or with the manufacturer.",
    faqs: [
      { q: "Is E200 (sorbic acid) halal?", a: "Yes — it is a synthetic preservative with no animal origin, so it is generally considered halal. The finished product still needs verification." },
      { q: "Is sorbic acid from animals?", a: "No. It is manufactured synthetically." },
      { q: "What names should I look for?", a: "'Sorbic acid' or 'E200'." },
    ],
    relatedCodes: ["E202", "E210", "E211"],
  ...
  {
    code: "E270", name: "Lactic acid", category: "Preservative", status: "halal",
    origin: "Usually made by bacterial fermentation of plant sugars.",
    note: "Very rarely uses dairy; generally accepted as halal.",
    aliases: ["lactic acid", "e270"],
    insNumber: "270",
    alternativeNames: ["Lactic acid", "2-hydroxypropanoic acid"],
    fn: "Acidity regulator / preservative",
    confidence: "high",
    originType: "microbial",
    originSummary: "E270 (Lactic acid) is usually made by bacterial fermentation of plant sugars and is generally accepted as halal; despite the name it is not necessarily from milk.",
    description: "Lactic acid is a mild acid used to adjust acidity and preserve foods. Despite its name (from Latin for milk), commercial lactic acid is normally produced by fermenting plant sugars with bacteria, not from dairy.",
    manufacturingSummary: "Produced by bacterial fermentation of carbohydrates (such as corn or beet sugar), then purified. A dairy substrate is very rarely used.",
    halalReasoning: "Lactic acid is generally classified as halal because it is normally made by fermenting plant sugars, with no animal or alcohol component. The 'lactic' name does not mean it is from milk. As always, the finished product still needs its own verification.",
    verificationAdvice: "Lactic acid is generally halal; if you follow a strict standard, choose a certified product or ask the manufacturer about the fermentation substrate.",
    commonUses: ["Pickles and sauces", "Dairy and fermented foods", "Bakery and dressings", "Soft drinks and confectionery"],
    labelNames: ["Lactic acid", "E270", "Acidity regulator (E270)"],
    singaporeGuidance: "Ingredient guidance is not certification. Verify the finished product on the MUIS HalalSG register or with the manufacturer.",
    faqs: [
      { q: "Is E270 (lactic acid) halal?", a: "Yes — it is normally made by fermenting plant sugars and is generally accepted as halal. Despite the name, it is not necessarily from milk." },
      { q: "Is lactic acid from milk?", a: "Usually not. Commercial lactic acid is normally produced by fermenting plant sugars; a dairy substrate is very rarely used." },
      { q: "What names should I look for?", a: "'Lactic acid' or 'E270'." },
    ],
    relatedCodes: ["E325", "E330", "E260"],
    sources: [efsaTopic("Lactic acid (E 270) — food additive information", "Plant-sugar fermentation origin"), codexGsfa(), muisSource()],
    lastReviewed: REVIEWED,
  },
  ...
  {
    code: "E406", name: "Agar", category: "Thickener", status: "halal",
    origin: "Gelling agent from seaweed — a common halal alternative to gelatine.",
    aliases: ["agar agar", "agar", "e406", "kanten"],
    insNumber: "406",
    alternativeNames: ["Agar", "Agar-agar", "Kanten"],
    fn: "Gelling agent / thickener",
    confidence: "high",
    originType: "plant",
    originSummary: "E406 (Agar) is a gelling agent extracted from seaweed — a plant source — so it is generally considered halal, and is a common halal alternative to gelatine.",
    description: "Agar (agar-agar) is a firm gelling agent extracted from red seaweed. It sets more firmly than gelatine and is widely used in desserts, jellies and vegetarian cooking — a popular halal substitute for gelatine.",
    manufacturingSummary: "Extracted from red seaweed by boiling, then filtered, gelled and dried. No animal-derived material.",
    halalReasoning: "Agar is extracted from seaweed with no animal-derived material, so it is generally classified as halal. It is one of the main plant-based substitutes for gelatine. As always, the finished product still needs its own verification.",
    verificationAdvice: "Agar itself is a halal, plant-based ingredient; still confirm the whole product and its certification for a finished item.",
    commonUses: ["Jellies and desserts", "Vegetarian/vegan gummies", "Dairy and confectionery", "Bakery fillings and glazes"],
    labelNames: ["Agar", "Agar-agar", "E406", "Gelling agent (E406)"],
    singaporeGuidance: "Ingredient guidance is not certification. Verify the finished product on the MUIS HalalSG register or with the manufacturer.",
    faqs: [
      { q: "Is E406 (agar) halal?", a: "Yes — it is extracted from seaweed (a plant) with no animal-derived material, so it is generally considered halal. It is a common halal alternative to gelatine." },
      { q: "Is agar the same as gelatine?", a: "No. Gelatine is animal-derived; agar is a plant (seaweed) gelling agent widely used as a halal substitute." },
      { q: "What names should I look for?", a: "'Agar', 'Agar-agar' or 'E406'." },
    ],
    relatedCodes: ["E407", "E440", "E441", "E415"],
    sources: [efsaTopic("Re-evaluation of agar (E 406) as a food additive", "Seaweed (plant) origin"), codexGsfa(), muisSource()],
    lastReviewed: REVIEWED,
  },
  ...
  {
    code: "E412", name: "Guar gum", category: "Thickener", status: "halal",
    origin: "From guar beans — plant.",
    aliases: ["guar gum", "e412", "guaran"],
    insNumber: "412",
    alternativeNames: ["Guar gum", "Guaran", "Guar flour"],
    fn: "Thickener / stabiliser",
    confidence: "high",
    originType: "plant",
    originSummary: "E412 (Guar gum) is a thickener milled from guar beans — a plant source — so it is generally considered halal.",
    description: "Guar gum is a thickening and stabilising agent made by milling the seeds (endosperm) of the guar bean. It thickens without heating and is widely used in sauces, dairy and gluten-free baking.",
    manufacturingSummary: "The guar bean's endosperm is separated and milled into a fine powder. No animal-derived material.",
    halalReasoning: "Guar gum is milled from a plant (guar beans) with no animal-derived material, so it is generally classified as halal. As always, the finished product still needs its own verification.",
    verificationAdvice: "Guar gum itself is a halal, plant-based ingredient; still confirm the whole product and its certification for a finished item.",
    commonUses: ["Sauces, dressings and soups", "Ice cream and dairy products", "Gluten-free and baked goods", "Instant mixes"],
    labelNames: ["Guar gum", "E412", "Guaran", "Thickener (E412)"],
    singaporeGuidance: "Ingredient guidance is not certification. Verify the finished product on the MUIS HalalSG register or with the manufacturer.",
    faqs: [
      { q: "Is E412 (guar gum) halal?", a: "Yes — it is milled from guar beans (a plant) with no animal-derived material, so it is generally considered halal. The finished product still needs verification." },
      { q: "Is guar gum from animals?", a: "No. It is a plant-based thickener made from guar beans." },
      { q: "What names should I look for?", a: "'Guar gum', 'E412' or 'Guaran'." },
    ],
    relatedCodes: ["E410", "E414", "E415", "E440"],
    sources: [efsaTopic("Re-evaluation of guar gum (E 412) as a food additive", "Plant (guar bean) origin"), codexGsfa(), muisSource()],
    lastReviewed: REVIEWED,
  },
  {
    code: "E414", name: "Gum arabic (Acacia gum)", category: "Thickener", status: "halal",
    origin: "From acacia tree sap — plant.",
    aliases: ["acacia gum", "gum arabic", "e414", "gum acacia"],
    insNumber: "414",
    alternativeNames: ["Gum arabic", "Acacia gum", "Gum acacia"],
    fn: "Thickener / stabiliser / glazing",
    confidence: "high",
    originType: "plant",
    originSummary: "E414 (Gum arabic / Acacia gum) is the dried sap of the acacia tree — a plant source — so it is generally considered halal.",
    description: "Gum arabic is a natural gum made from the hardened sap of acacia trees. It is used to stabilise, thicken and emulsify, and to coat sweets and keep flavour oils dissolved in soft drinks.",
    manufacturingSummary: "Collected as dried sap (exudate) from acacia trees, then cleaned and processed. No animal-derived material.",
    halalReasoning: "Gum arabic is a plant exudate with no animal-derived material, so it is generally classified as halal. As always, the finished product still needs its own verification.",
    verificationAdvice: "Gum arabic itself is a halal, plant-based ingredient; still confirm the whole product and its certification for a finished item.",
    commonUses: ["Soft drinks (to hold flavour oils)", "Confectionery and gummies", "Icings and glazes", "Supplements and fibre products"],
    labelNames: ["Gum arabic", "Acacia gum", "E414", "Stabiliser (E414)"],
    singaporeGuidance: "Ingredient guidance is not certification. Verify the finished product on the MUIS HalalSG register or with the manufacturer.",
    faqs: [
      { q: "Is E414 (gum arabic) halal?", a: "Yes — it is the dried sap of the acacia tree (a plant) with no animal-derived material, so it is generally considered halal. The finished product still needs verification." },
      { q: "Is gum arabic from animals?", a: "No. It is a plant gum collected from acacia trees." },
      { q: "What names should I look for?", a: "'Gum arabic', 'Acacia gum' or 'E414'." },
    ],
    relatedCodes: ["E412", "E410", "E415", "E440"],
    sources: [efsaTopic("Re-evaluation of acacia gum (E 414) as a food additive", "Plant exudate origin"), codexGsfa(), muisSource()],
    lastReviewed: REVIEWED,
  },
  ...
  {
    code: "E440", name: "Pectin", category: "Thickener", status: "halal",
    origin: "From fruit — plant-based gelling agent.",
    aliases: ["pectin", "e440", "fruit pectin"],
    insNumber: "440",
    alternativeNames: ["Pectin", "Fruit pectin", "Amidated pectin (E440ii)"],
    fn: "Gelling agent / thickener / stabiliser",
    confidence: "high",
    originType: "plant",
    originSummary: "E440 (Pectin) is a plant-based gelling agent extracted from fruit, so it is generally considered halal — and is a common halal alternative to gelatine.",
    description: "Pectin is a natural carbohydrate found in fruit, extracted mainly from citrus peel and apple pomace. It sets jams and jellies and is widely used to thicken and stabilise foods. Because it is plant-derived, it is a popular halal and vegetarian alternative to gelatine.",
    manufacturingSummary: "Extracted from fruit (citrus peel, apple pomace) with hot acidified water, then purified and dried. No animal-derived material.",
    halalReasoning: "Pectin is extracted from fruit and involves no animal-derived material, so it is generally classified as halal. It is one of the standard plant-based substitutes for gelatine in jellies and gummy-style sweets. As always, the finished product still needs its own verification.",
    verificationAdvice: "Pectin itself is a halal, plant-based ingredient; still confirm the whole product and its certification for a finished item.",
    commonUses: ["Jams, jellies and marmalades", "Fruit gummies and pastilles", "Yoghurts and fruit preparations", "Dairy desserts and drinks"],
    labelNames: ["Pectin", "E440", "Fruit pectin", "Gelling agent (E440)"],
    singaporeGuidance: "Ingredient guidance is not certification. Verify the finished product on the MUIS HalalSG register or with the manufacturer.",
    faqs: [
      { q: "Is E440 (pectin) halal?", a: "Yes — pectin is extracted from fruit with no animal-derived material, so it is generally considered halal. It is a common halal alternative to gelatine." },
      { q: "Is pectin the same as gelatine?", a: "No. Gelatine is animal-derived; pectin is a plant (fruit) gelling agent and is often used as a halal, vegetarian substitute." },
      { q: "What names should I look for?", a: "'Pectin', 'E440' or 'Fruit pectin'." },
    ],
    relatedCodes: ["E406", "E407", "E441", "E415"],
    sources: [efsaTopic("Re-evaluation of pectins (E 440) as a food additive", "Fruit (plant) origin and uses"), codexGsfa(), muisSource()],
    lastReviewed: REVIEWED,
  },
  {
    code: "E420", name: "Sorbitol", category: "Sweetener", status: "halal",
    origin: "Sugar alcohol, usually from corn/glucose.",
    aliases: ["sorbitol", "e420", "glucitol"],
    insNumber: "420",
    alternativeNames: ["Sorbitol", "Glucitol", "Sorbitol syrup"],
    fn: "Sweetener / humectant",
    confidence: "high",
    originType: "synthetic",
    originSummary: "E420 (Sorbitol) is a sugar alcohol made from plant glucose (usually corn), with no animal origin, so it is generally considered halal.",
    description: "Sorbitol is a sugar alcohol used as a lower-calorie sweetener and humectant (to keep foods moist). It is made industrially from glucose, typically corn-derived.",
    manufacturingSummary: "Produced by hydrogenating glucose (usually from corn starch). No animal-derived raw materials.",
    halalReasoning: "Sorbitol is made from plant sugars with no animal or alcohol component, so it is generally classified as halal. Despite being called a 'sugar alcohol', it is not an intoxicating alcohol. As always, the finished product still needs its own verification.",
    verificationAdvice: "Sorbitol itself is halal; still confirm the whole product and its certification for a finished item.",
    commonUses: ["Sugar-free sweets and gum", "Diabetic and low-sugar foods", "Toothpaste and mouthwash", "Baked goods (as a humectant)"],
    labelNames: ["Sorbitol", "E420", "Sweetener (E420)"],
    singaporeGuidance: "Ingredient guidance is not certification. Verify the finished product on the MUIS HalalSG register or with the manufacturer.",
    faqs: [
      { q: "Is E420 (sorbitol) halal?", a: "Yes — it is a sugar alcohol made from plant glucose with no animal origin, so it is generally considered halal. It is not an intoxicating alcohol." },
      { q: "Is sorbitol alcohol?", a: "It is a 'sugar alcohol' by chemistry, but not the intoxicating kind (ethanol). It does not intoxicate and is generally considered halal." },
      { q: "What names should I look for?", a: "'Sorbitol' or 'E420'." },
    ],
    relatedCodes: ["E421", "E965", "E967", "E951"],
    sources: [efsaTopic("Re-evaluation of sorbitol (E 420) as a food additive", "Plant-glucose origin"), codexGsfa(), muisSource()],
    lastReviewed: REVIEWED,
  },
  ...
  {
    code: "E466", name: "Carboxymethylcellulose (CMC)", category: "Thickener", status: "halal",
    origin: "From plant cellulose.",
    aliases: ["cmc", "cellulose gum", "e466", "carboxymethylcellulose", "sodium carboxymethyl cellulose"],
    insNumber: "466",
    alternativeNames: ["Carboxymethylcellulose", "Cellulose gum", "Sodium carboxymethyl cellulose", "CMC"],
    fn: "Thickener / stabiliser",
    confidence: "high",
    originType: "plant",
    originSummary: "E466 (Carboxymethylcellulose / cellulose gum) is made from plant cellulose, so it is generally considered halal.",
    description: "Carboxymethylcellulose, often labelled 'cellulose gum', is a thickener and stabiliser made by chemically modifying plant cellulose (from wood or cotton). It thickens and improves texture in a wide range of foods.",
    manufacturingSummary: "Plant cellulose is treated with chemicals to attach carboxymethyl groups, then purified. The raw material is plant-based; no animal-derived material.",
    halalReasoning: "CMC is made from plant cellulose with no animal-derived material, so it is generally classified as halal. As always, the finished product still needs its own verification.",
    verificationAdvice: "CMC (cellulose gum) itself is a halal, plant-based ingredient; still confirm the whole product and its certification for a finished item.",
    commonUses: ["Ice cream and dairy products", "Sauces, dressings and drinks", "Baked goods and gluten-free foods", "Toothpaste and some medicines"],
    labelNames: ["Carboxymethylcellulose", "Cellulose gum", "E466", "Thickener (E466)"],
    singaporeGuidance: "Ingredient guidance is not certification. Verify the finished product on the MUIS HalalSG register or with the manufacturer.",
    faqs: [
      { q: "Is E466 (CMC / cellulose gum) halal?", a: "Yes — it is made from plant cellulose with no animal-derived material, so it is generally considered halal. The finished product still needs verification." },
      { q: "Is cellulose gum from animals?", a: "No. It is made from plant cellulose (wood or cotton)." },
      { q: "What names should I look for?", a: "'Carboxymethylcellulose', 'Cellulose gum', 'CMC' or 'E466'." },
    ],
    relatedCodes: ["E440", "E412", "E415", "E1400"],
    sources: [efsaTopic("Re-evaluation of carboxymethylcellulose (E 466) as a food additive", "Plant cellulose origin"), codexGsfa(), muisSource()],
    lastReviewed: REVIEWED,
  },
  ...
  {
    code: "E551", name: "Silicon dioxide", category: "Anti-caking", status: "halal",
    origin: "Mineral (silica).",
    aliases: ["silica", "silicon dioxide", "e551", "sio2"],
    insNumber: "551",
    alternativeNames: ["Silicon dioxide", "Silica", "SiO2"],
    fn: "Anti-caking agent",
    confidence: "high",
    originType: "mineral",
    originSummary: "E551 (Silicon dioxide / silica) is a mineral anti-caking agent with no animal origin, so it is generally considered halal.",
    description: "Silicon dioxide, or silica, is a mineral used as an anti-caking agent to keep powders free-flowing and dry. It is common in powdered foods, seasonings and supplements.",
    manufacturingSummary: "Produced from mineral silica (or synthesised as fumed/precipitated silica) to food grade. No animal-derived material.",
    halalReasoning: "Silicon dioxide is a mineral with no animal or alcohol component, so it is generally classified as halal. As always, the finished product still needs its own verification.",
    verificationAdvice: "Silicon dioxide itself is a mineral and halal; still confirm the whole product and its certification for a finished item.",
    commonUses: ["Powdered and instant foods", "Seasonings and spice blends", "Supplements and tablets", "Coffee whiteners and salt"],
    labelNames: ["Silicon dioxide", "Silica", "E551", "Anti-caking agent (E551)"],
    singaporeGuidance: "Ingredient guidance is not certification. Verify the finished product on the MUIS HalalSG register or with the manufacturer.",
    faqs: [
      { q: "Is E551 (silicon dioxide) halal?", a: "Yes — it is a mineral (silica) with no animal origin, so it is generally considered halal. The finished product still needs verification." },
      { q: "Is silicon dioxide from animals?", a: "No. It is a mineral (or synthesised silica)." },
      { q: "What names should I look for?", a: "'Silicon dioxide', 'Silica' or 'E551'." },
    ],
    relatedCodes: ["E170", "E500", "E341"],
    sources: [efsaTopic("Re-evaluation of silicon dioxide (E 551) as a food additive", "Mineral (silica) origin"), codexGsfa(), muisSource()],
    lastReviewed: REVIEWED,
  },
  {
  ...
  {
    code: "E901", name: "Beeswax", category: "Glazing & wax", status: "halal",
    origin: "Produced by honeybees — generally permissible, like honey.",
    aliases: ["beeswax", "e901", "white beeswax", "yellow beeswax", "cera alba"],
    insNumber: "901",
    alternativeNames: ["Beeswax", "White beeswax", "Yellow beeswax", "Cera alba"],
    fn: "Glazing agent / wax",
    confidence: "high",
    originType: "animal",
    originSummary: "E901 (Beeswax) is a wax produced by honeybees; it is generally considered permissible, like honey, so it is treated as halal.",
    description: "Beeswax is a natural wax made by honeybees to build their honeycomb. As a food additive it is used as a glazing agent to give a shine to sweets and coated products, and to wax some fruits.",
    manufacturingSummary: "Collected from honeycomb, melted, filtered and purified into white or yellow beeswax. It is a bee product, like honey.",
    halalReasoning: "Beeswax is a product of the honeybee, and the majority view treats bee products such as honey and beeswax as permissible. It is therefore generally classified as halal. As always, the finished product still needs its own verification, and a beeswax glaze may sometimes be applied using a carrier that should be checked.",
    verificationAdvice: "Beeswax itself is generally halal; for a finished product, still confirm the whole ingredient list and any halal certification, and check the glaze carrier if that matters to you.",
    commonUses: ["Glazes on sweets and chocolates", "Coated tablets and supplements", "Wax coatings on fruit", "Chewing gum"],
    labelNames: ["Beeswax", "White beeswax", "Yellow beeswax", "E901", "Glazing agent (E901)"],
    singaporeGuidance: "Ingredient guidance is not certification. Verify the finished product on the MUIS HalalSG register or with the manufacturer.",
    faqs: [
      { q: "Is E901 (beeswax) halal?", a: "Yes — beeswax is a bee product and, like honey, is generally treated as permissible, so it is considered halal. The finished product still needs verification." },
      { q: "Is beeswax an animal product?", a: "It is produced by honeybees. The majority view treats bee products such as honey and beeswax as permissible." },
      { q: "What names should I look for?", a: "'Beeswax', 'White/Yellow beeswax', 'Cera alba' or 'E901'." },
    ],
    relatedCodes: ["E903", "E904", "E160b"],
    sources: [efsaTopic("Beeswax (E 901) — food additive information", "Bee-product origin and use as a glaze"), codexGsfa(), muisSource()],
    lastReviewed: REVIEWED,
  },
  {
    code: "E903", name: "Carnauba wax", category: "Glazing & wax", status: "halal",
    origin: "From the carnauba palm — plant-derived.",
    aliases: ["carnauba wax", "e903", "carnauba", "brazil wax"],
    insNumber: "903",
    alternativeNames: ["Carnauba wax", "Brazil wax", "Palm wax"],
    fn: "Glazing agent / wax",
    confidence: "high",
    originType: "plant",
    originSummary: "E903 (Carnauba wax) is obtained from the leaves of the carnauba palm — a plant source — so it is generally considered halal.",
    description: "Carnauba wax is a hard plant wax obtained from the leaves of the Brazilian carnauba palm. It is used as a glazing agent to give a shine and protective coat to sweets, chocolates, coated tablets and some fruits.",
    manufacturingSummary: "Collected from dried carnauba palm leaves, then refined into wax. No animal-derived material.",
    halalReasoning: "Carnauba wax is a plant wax with no animal-derived material, so it is generally classified as halal — and it is a common plant-based glazing alternative to shellac. As always, the finished product still needs its own verification.",
    verificationAdvice: "Carnauba wax itself is a halal, plant-based ingredient; still confirm the whole product and its certification for a finished item.",
    commonUses: ["Glazes on sweets and chocolates", "Coated tablets and supplements", "Wax coatings on fruit", "Chewing gum"],
    labelNames: ["Carnauba wax", "Brazil wax", "E903", "Glazing agent (E903)"],
    singaporeGuidance: "Ingredient guidance is not certification. Verify the finished product on the MUIS HalalSG register or with the manufacturer.",
    faqs: [
      { q: "Is E903 (carnauba wax) halal?", a: "Yes — it is a plant wax from the carnauba palm with no animal-derived material, so it is generally considered halal. It is a common plant-based alternative to shellac." },
      { q: "Is carnauba wax from animals?", a: "No. It is obtained from the leaves of the carnauba palm." },
      { q: "What names should I look for?", a: "'Carnauba wax', 'Brazil wax' or 'E903'." },
    ],
    relatedCodes: ["E901", "E904", "E160b"],
    sources: [efsaTopic("Carnauba wax (E 903) — food additive information", "Plant (palm) origin"), codexGsfa(), muisSource()],
    lastReviewed: REVIEWED,
  },
  {
  ...
  // ── Sweeteners ─────────────────────────────────────────────────────────────
  {
    code: "E950", name: "Acesulfame K", category: "Sweetener", status: "halal",
    origin: "Synthetic sweetener.",
    aliases: ["ace k", "acesulfame k", "e950", "acesulfame potassium", "ace-k"],
    insNumber: "950",
    alternativeNames: ["Acesulfame K", "Acesulfame potassium", "Ace-K"],
    fn: "Sweetener (high-intensity)",
    confidence: "high",
    originType: "synthetic",
    originSummary: "E950 (Acesulfame K) is a synthetic high-intensity sweetener with no animal origin, so it is generally considered halal.",
    description: "Acesulfame potassium (Ace-K) is a calorie-free synthetic sweetener about 200 times sweeter than sugar, often blended with other sweeteners in diet drinks and sugar-free products.",
    manufacturingSummary: "Manufactured by chemical synthesis. No animal-derived raw materials.",
    halalReasoning: "Acesulfame K is synthesised with no animal or alcohol component, so it is generally classified as halal. As always, the finished product still needs its own verification.",
    verificationAdvice: "Acesulfame K itself is halal; still confirm the whole product and its certification for a finished item.",
    commonUses: ["Diet and sugar-free soft drinks", "Sugar-free gum and sweets", "Tabletop sweeteners", "Low-calorie dairy and desserts"],
    labelNames: ["Acesulfame K", "Acesulfame potassium", "Ace-K", "E950", "Sweetener (E950)"],
    singaporeGuidance: "Ingredient guidance is not certification. Verify the finished product on the MUIS HalalSG register or with the manufacturer.",
    faqs: [
      { q: "Is E950 (acesulfame K) halal?", a: "Yes — it is a synthetic sweetener with no animal origin, so it is generally considered halal. The finished product still needs verification." },
      { q: "Is acesulfame K from animals?", a: "No. It is manufactured synthetically." },
      { q: "What names should I look for?", a: "'Acesulfame K', 'Acesulfame potassium', 'Ace-K' or 'E950'." },
    ],
    relatedCodes: ["E951", "E954", "E955", "E960"],
    sources: [efsaTopic("Re-evaluation of acesulfame K (E 950) as a food additive", "Synthetic origin"), codexGsfa(), muisSource()],
    lastReviewed: REVIEWED,
  },
  ...
  {
    code: "E960", name: "Steviol glycosides (Stevia)", category: "Sweetener", status: "halal",
    origin: "From the stevia plant.",
    aliases: ["stevia", "e960", "steviol glycosides", "rebaudioside"],
    insNumber: "960",
    alternativeNames: ["Steviol glycosides", "Stevia", "Rebaudioside A"],
    fn: "Sweetener (high-intensity)",
    confidence: "high",
    originType: "plant",
    originSummary: "E960 (Steviol glycosides / Stevia) is a high-intensity sweetener extracted from the stevia plant, so it is generally considered halal.",
    description: "Steviol glycosides are natural, intense sweeteners extracted from the leaves of the stevia plant. They are used to sweeten drinks and foods with no calories, often blended with other sweeteners.",
    manufacturingSummary: "Extracted and purified from stevia leaves with water and filtration. Some newer versions are made by fermentation. No animal-derived material.",
    halalReasoning: "Stevia sweeteners are extracted from a plant with no animal or intoxicating-alcohol component, so they are generally classified as halal. As always, the finished product still needs its own verification.",
    verificationAdvice: "Steviol glycosides themselves are halal; still confirm the whole product and its certification for a finished item.",
    commonUses: ["Diet and 'no added sugar' drinks", "Tabletop sweeteners", "Low-calorie yoghurts and desserts", "Sugar-free confectionery"],
    labelNames: ["Steviol glycosides", "Stevia", "E960", "Sweetener (E960)"],
    singaporeGuidance: "Ingredient guidance is not certification. Verify the finished product on the MUIS HalalSG register or with the manufacturer.",
    faqs: [
      { q: "Is E960 (stevia) halal?", a: "Yes — steviol glycosides are extracted from the stevia plant with no animal origin, so they are generally considered halal. The finished product still needs verification." },
      { q: "Is stevia natural?", a: "It is extracted from the leaves of the stevia plant (some newer versions are made by fermentation). Either way it is generally considered halal." },
      { q: "What names should I look for?", a: "'Steviol glycosides', 'Stevia', 'E960' or 'Rebaudioside A'." },
    ],
    relatedCodes: ["E950", "E951", "E955", "E967"],
    sources: [efsaTopic("Steviol glycosides (E 960) — food additive information", "Plant (stevia) origin"), codexGsfa(), muisSource()],
    lastReviewed: REVIEWED,
  },
  {
    code: "E965", name: "Maltitol", category: "Sweetener", status: "halal",
    origin: "Sugar alcohol from starch.",
    aliases: ["maltitol", "e965", "maltitol syrup"],
    insNumber: "965",
    alternativeNames: ["Maltitol", "Maltitol syrup", "Hydrogenated glucose syrup"],
    fn: "Sweetener",
    confidence: "high",
    originType: "synthetic",
    originSummary: "E965 (Maltitol) is a sugar alcohol made from plant starch, with no animal origin, so it is generally considered halal.",
    description: "Maltitol is a sugar alcohol used as a sugar replacement in sugar-free and reduced-sugar sweets and chocolate. It is made from starch, typically corn or wheat.",
    manufacturingSummary: "Produced by hydrogenating maltose derived from plant starch. No animal-derived raw materials.",
    halalReasoning: "Maltitol is made from plant starch with no animal or intoxicating-alcohol component, so it is generally classified as halal. As always, the finished product still needs its own verification.",
    verificationAdvice: "Maltitol itself is halal; still confirm the whole product and its certification for a finished item.",
    commonUses: ["Sugar-free chocolate and sweets", "Reduced-sugar baked goods", "Chewing gum", "Diabetic foods"],
    labelNames: ["Maltitol", "Maltitol syrup", "E965", "Sweetener (E965)"],
    singaporeGuidance: "Ingredient guidance is not certification. Verify the finished product on the MUIS HalalSG register or with the manufacturer.",
    faqs: [
      { q: "Is E965 (maltitol) halal?", a: "Yes — it is a sugar alcohol made from plant starch with no animal origin, so it is generally considered halal. It is not an intoxicating alcohol." },
      { q: "Is maltitol from animals?", a: "No. It is produced from plant starch (usually corn or wheat)." },
      { q: "What names should I look for?", a: "'Maltitol', 'Maltitol syrup' or 'E965'." },
    ],
    relatedCodes: ["E420", "E967", "E421", "E951"],
    sources: [efsaTopic("Re-evaluation of maltitol (E 965) as a food additive", "Plant-starch origin"), codexGsfa(), muisSource()],
    lastReviewed: REVIEWED,
  },
  {
    code: "E967", name: "Xylitol", category: "Sweetener", status: "halal",
    origin: "Sugar alcohol from plant fibre.",
    aliases: ["xylitol", "e967", "birch sugar"],
    insNumber: "967",
    alternativeNames: ["Xylitol", "Birch sugar"],
    fn: "Sweetener",
    confidence: "high",
    originType: "synthetic",
    originSummary: "E967 (Xylitol) is a sugar alcohol made from plant fibre (such as birch or corn), with no animal origin, so it is generally considered halal.",
    description: "Xylitol is a sugar alcohol used as a tooth-friendly, lower-calorie sweetener, especially in sugar-free gum and mints. It is produced from plant materials such as birch wood or corn cobs.",
    manufacturingSummary: "Produced by processing and hydrogenating xylose from plant fibre (e.g. birch, corn cobs). No animal-derived raw materials.",
    halalReasoning: "Xylitol is made from plant fibre with no animal or intoxicating-alcohol component, so it is generally classified as halal. As always, the finished product still needs its own verification.",
    verificationAdvice: "Xylitol itself is halal; still confirm the whole product and its certification for a finished item.",
    commonUses: ["Sugar-free gum and mints", "Tooth-friendly sweets", "Diabetic and low-sugar foods", "Toothpaste and oral-care products"],
    labelNames: ["Xylitol", "E967", "Birch sugar", "Sweetener (E967)"],
    singaporeGuidance: "Ingredient guidance is not certification. Verify the finished product on the MUIS HalalSG register or with the manufacturer.",
    faqs: [
      { q: "Is E967 (xylitol) halal?", a: "Yes — it is a sugar alcohol made from plant fibre with no animal origin, so it is generally considered halal. It is not an intoxicating alcohol." },
      { q: "Is xylitol from animals?", a: "No. It is produced from plant materials such as birch wood or corn cobs." },
      { q: "What names should I look for?", a: "'Xylitol', 'E967' or 'Birch sugar'." },
    ],
    relatedCodes: ["E420", "E965", "E421", "E960"],
    sources: [efsaTopic("Re-evaluation of xylitol (E 967) as a food additive", "Plant-fibre origin"), codexGsfa(), muisSource()],
    lastReviewed: REVIEWED,
  },
  ...
  {
    code: "E1520", name: "Propylene glycol", category: "Other", status: "halal",
    origin: "Synthetic humectant/carrier solvent — not an intoxicating alcohol.",
    note: "Distinct from ethanol; not an intoxicant. Generally halal.",
    aliases: ["propylene glycol", "e1520", "propane-1,2-diol", "mpg", "1,2-propanediol"],
    insNumber: "1520",
    alternativeNames: ["Propylene glycol", "Propane-1,2-diol", "1,2-propanediol", "MPG"],
    fn: "Humectant / carrier solvent",
    confidence: "high",
    originType: "synthetic",
    originSummary: "E1520 (Propylene glycol) is a synthetic humectant and carrier solvent; it is not an intoxicating alcohol and has no animal origin, so it is generally considered halal.",
    description: "Propylene glycol is a synthetic liquid used to keep foods moist and to carry flavours and colours. Despite 'glycol' in the name, it is not the same as ethanol (drinking alcohol) and does not intoxicate.",
    manufacturingSummary: "Manufactured by chemical synthesis (from propylene oxide). No animal-derived raw materials.",
    halalReasoning: "Propylene glycol is synthesised with no animal component and is not an intoxicant, so it is generally classified as halal. It should not be confused with ethanol (E1510). As always, the finished product still needs its own verification.",
    verificationAdvice: "Propylene glycol itself is generally halal; still confirm the whole product and its certification for a finished item, and do not confuse it with ethanol.",
    commonUses: ["Flavour and colour carriers", "Icings, fillings and cake mixes", "Soft drinks and some dairy", "Medicines and personal-care products"],
    labelNames: ["Propylene glycol", "E1520", "Propane-1,2-diol", "Humectant (E1520)"],
    singaporeGuidance: "Ingredient guidance is not certification. Verify the finished product on the MUIS HalalSG register or with the manufacturer.",
    faqs: [
      { q: "Is E1520 (propylene glycol) halal?", a: "Yes — it is a synthetic humectant/solvent that is not an intoxicating alcohol and has no animal origin, so it is generally considered halal. The finished product still needs verification." },
      { q: "Is propylene glycol alcohol?", a: "It is a 'glycol', not ethanol (drinking alcohol). It does not intoxicate and is generally considered halal — unlike ethanol (E1510)." },
      { q: "What names should I look for?", a: "'Propylene glycol', 'Propane-1,2-diol' or 'E1520'." },
    ],
    relatedCodes: ["E422", "E1510", "E420"],
    sources: [efsaTopic("Propylene glycol (E 1520) — food additive information", "Synthetic origin and uses"), codexGsfa(), muisSource()],
    lastReviewed: REVIEWED,
  },
  {
    code: "", name: "Rennet", category: "Other", status: "mushbooh",
    origin: "Enzyme used to make cheese; can be from animal stomach (halal only if from a halal animal), or microbial/plant (halal).",
    note: "Look for 'microbial rennet' or 'vegetarian rennet' — those are halal.",
    aliases: ["rennet", "cheese enzyme", "rennin", "chymosin"],
    slug: "rennet",
    alternativeNames: ["Rennet", "Rennin", "Chymosin", "Microbial rennet", "Vegetarian rennet"],
    fn: "Enzyme (cheese coagulant)",
    confidence: "medium",
    originType: "variable",
    originSummary: "Rennet is the enzyme used to curdle milk into cheese; it can come from animal stomach (halal only if from a halal-slaughtered animal), or be microbial or plant-based (halal) — so it is treated as doubtful (mushbooh) unless the source is known.",
    description: "Rennet is a set of enzymes used to coagulate milk when making cheese. Traditional 'animal rennet' comes from the stomach lining of young calves; modern cheese often uses microbial rennet or fermentation-produced chymosin, and some uses plant-based coagulants.",
    manufacturingSummary: "Animal rennet is extracted from the stomachs of calves (or other animals). Microbial rennet is produced by fermentation; fermentation-produced chymosin (FPC) is made by microbes carrying the chymosin gene. Plant coagulants also exist.",
    halalReasoning: "Rennet's status depends on its source. Microbial rennet, fermentation-produced chymosin and plant coagulants are halal. Animal rennet is permissible only if it comes from a halal-slaughtered, permissible animal — calf rennet from non-halal slaughter is treated as doubtful-to-avoid by most scholars. Because cheese labels often just say 'rennet' or 'enzymes', the honest default is to verify.",
    verificationAdvice: "Look for 'microbial rennet', 'vegetarian rennet' or 'not made with animal rennet' (all halal), or halal certification. If a cheese lists only 'rennet' or 'enzymes', ask the manufacturer whether it is microbial/plant or animal — and, if animal, whether it is halal-certified.",
    commonUses: ["Hard and soft cheeses", "Some cottage cheese and paneer-style products", "Certain dairy desserts"],
    labelNames: ["Rennet", "Microbial rennet", "Vegetarian rennet", "Chymosin", "Enzymes"],
    singaporeGuidance: "In Singapore, verify the cheese/product on the MUIS HalalSG register. Certified cheeses use an approved (microbial, FPC or halal animal) rennet; for an uncertified cheese listing only 'rennet' or 'enzymes', treat it as doubtful and contact the manufacturer.",
    faqs: [
      { q: "Is rennet halal?", a: "It depends on the source. Microbial rennet, fermentation-produced chymosin and plant coagulants are halal. Animal rennet is halal only if from a halal-slaughtered animal — otherwise it is doubtful-to-avoid. Since labels rarely say, verify." },
      { q: "Is the cheese I'm eating made with halal rennet?", a: "Check for 'microbial' or 'vegetarian' rennet, or halal certification. If the label only says 'rennet' or 'enzymes', ask the manufacturer about the source." },
      { q: "What is vegetarian rennet?", a: "Rennet that is not from animal stomach — usually microbial or fermentation-produced chymosin, or a plant coagulant. These are halal." },
      { q: "What names should I look for on a label?", a: "'Microbial rennet', 'vegetarian rennet' or 'chymosin' (halal); plain 'rennet' or 'enzymes' should be verified." },
    ],
    relatedCodes: ["E441", "E1105", "E322"],
    sources: [
      { title: "Halal Certification — HalalSG (assessment of enzymes and processing aids)", organisation: "Majlis Ugama Islam Singapura (MUIS)", url: "https://www.muis.gov.sg/halal", sourceType: "certification", accessedDate: REVIEWED, supports: "Rennet/enzyme source is assessed during cheese certification" },
      codexGsfa("Enzyme preparations (rennet/chymosin) and their uses"),
    ],
    lastReviewed: REVIEWED,
  },
...
export function ingredientQualifies(a: Additive): boolean {
  ...
  // Name-only pointers that duplicate a coded entry (e.g. Carmine → E120) are
  // excluded; a codeless ingredient may still qualify if it pins an explicit
  // slug AND is not just an alias of a coded entry (e.g. Rennet, which has no
  // E-number of its own).
  if (!a.code && !a.slug) return false;
