...
export const ADDITIVES: Additive[] = [
  ...
  // ── Common non-E-number ingredients people search ("is X halal") ───────────
  {
    code: "", name: "Lard", category: "Other", status: "haram",
    origin: "Rendered pork fat — from pork, so it is haram.",
    note: "Any ingredient derived from pork is haram; look for vegetable shortening or halal-certified fats instead.",
    aliases: ["lard", "pork fat", "pig fat", "rendered pork fat", "saindoux"],
    slug: "lard",
    alternativeNames: ["Lard", "Pork fat", "Rendered pork fat"],
    fn: "Fat / shortening",
    confidence: "high",
    originType: "animal",
    originSummary: "Lard is fat rendered from pigs. Because it is a pork derivative, it is haram — there is no halal version of pork lard.",
    description: "Lard is a semi-solid fat made by rendering (melting and clarifying) fatty pork tissue. It has historically been used for frying, pastry and baking because it produces a flaky texture.",
    manufacturingSummary: "Fatty tissue from pigs is heated so the fat separates, then filtered and solidified. It is, by definition, a pork product.",
    halalReasoning: "Pork and all its derivatives are explicitly prohibited in Islam, so lard is haram. This is not a source-dependent (mushbooh) case — lard is always from pigs. Foods fried in lard, or pastries and biscuits made with it, take on the same ruling.",
    verificationAdvice: "Read the ingredients list for 'lard' or 'pork fat', and be cautious with imported pastries, biscuits, refried beans and some traditional baked goods where lard is common. Choose products that list vegetable oil/shortening or that are halal-certified.",
    commonUses: ["Pastry, pie crust and some biscuits", "Deep-frying (some cuisines)", "Refried beans and certain savoury dishes", "Traditional imported baked goods"],
    labelNames: ["Lard", "Pork fat", "Animal fat (pork)", "Saindoux"],
    singaporeGuidance: "In Singapore, MUIS HalalSG-certified products do not contain lard. For uncertified imported snacks and baked goods, check the ingredients list and manufacturer, since lard is common in some overseas products.",
    faqs: [
      { q: "Is lard halal?", a: "No. Lard is rendered pork fat, and all pork derivatives are haram in Islam. There is no halal version of pork lard." },
      { q: "What can replace lard?", a: "Vegetable shortening, butter (from a halal source), or halal-certified fats. Check the ingredients list to confirm the fat is not animal/pork-derived." },
      { q: "Which foods commonly contain lard?", a: "Some pastries, pie crusts, biscuits, refried beans and imported baked goods. When in doubt, choose halal-certified products." },
      { q: "Is 'animal fat' the same as lard?", a: "'Animal fat' is vaguer — it may be from pork or another animal. Treat it as doubtful and verify the source unless the product is halal-certified." },
    ],
    relatedCodes: ["E471", "E570"],
    sources: [muisSource("Pork and pork derivatives are prohibited under halal certification"), codexGsfa("Animal fats — identity and uses")],
    lastReviewed: REVIEWED,
  },
  {
    code: "", name: "Mirin", category: "Other", status: "haram",
    origin: "Japanese sweet rice wine used in cooking — contains alcohol, so it is haram.",
    note: "Alcohol-free seasonings labelled 'mirin-style' or 'mirin-fu' exist; look for a halal-certified alternative.",
    aliases: ["mirin", "rice wine", "cooking wine", "sweet rice wine", "aji-mirin"],
    slug: "mirin",
    alternativeNames: ["Mirin", "Sweet rice wine", "Aji-mirin", "Mirin-fu (alcohol-free)"],
    fn: "Seasoning (rice wine)",
    confidence: "high",
    originType: "variable",
    originSummary: "Traditional mirin is a fermented sweet rice wine containing alcohol, so it is haram. Alcohol-free 'mirin-style' seasonings are a separate, permissible product.",
    description: "Mirin is a sweet Japanese condiment used in sauces, glazes and simmered dishes (teriyaki, sukiyaki, nimono). Genuine mirin (hon-mirin) is a fermented rice wine of roughly 14% alcohol; cheaper 'aji-mirin' also usually contains alcohol.",
    manufacturingSummary: "Traditional hon-mirin is made by fermenting glutinous rice with koji and shochu, producing an alcoholic sweet liquid. Non-alcoholic 'mirin-style' seasoning is formulated from rice syrup, vinegar and flavourings without the fermentation alcohol.",
    halalReasoning: "Intoxicating alcohol (khamr) is prohibited, and traditional mirin is an alcoholic rice wine, so it is haram. Because Japanese and Korean dishes such as teriyaki, sukiyaki and many glazes commonly use mirin (and sake/cooking wine), these dishes need checking. Alcohol-free 'mirin-style' seasonings are a different product and can be halal — verify the label and certification.",
    verificationAdvice: "Check labels for 'mirin', 'rice wine', 'cooking wine', 'sake' or 'alcohol'. For Japanese/Korean food, ask whether mirin or cooking wine is used, or choose halal-certified outlets and alcohol-free 'mirin-fu' seasonings.",
    commonUses: ["Teriyaki, sukiyaki and simmered (nimono) dishes", "Glazes and marinades", "Japanese and some Korean sauces", "Salad dressings and dipping sauces"],
    labelNames: ["Mirin", "Aji-mirin", "Sweet rice wine", "Rice wine", "Cooking wine"],
    singaporeGuidance: "In Singapore, MUIS HalalSG-certified Japanese/Korean restaurants and products do not use alcoholic mirin, sake or cooking wine. For uncertified eateries, ask specifically about mirin/cooking wine in sauces and glazes.",
    faqs: [
      { q: "Is mirin halal?", a: "No. Traditional mirin is a fermented sweet rice wine containing alcohol, which is haram. Look for alcohol-free 'mirin-style' seasoning or halal-certified products instead." },
      { q: "Is alcohol-free mirin halal?", a: "'Mirin-style' or 'mirin-fu' seasonings made without fermentation alcohol are a different product and can be halal — check the label and certification to confirm no added alcohol." },
      { q: "Does teriyaki contain mirin?", a: "Often, yes — teriyaki, sukiyaki and many Japanese glazes use mirin or sake. Verify with the manufacturer or restaurant, or choose halal-certified options." },
      { q: "What can I use instead of mirin?", a: "Alcohol-free mirin-style seasoning, or a mix of water/rice vinegar with a little sugar. Halal-certified Japanese sauces avoid alcoholic mirin." },
    ],
    relatedCodes: [],
    sources: [muisSource("Alcohol (khamr) and alcoholic cooking wines are not permitted under halal certification"), codexGsfa("Fermented rice condiments — composition")],
    lastReviewed: REVIEWED,
  },
  {
    code: "", name: "Shortening", category: "Emulsifier & stabiliser", status: "mushbooh",
    origin: "Solid baking fat — can be vegetable (halal) or animal/lard-based (check the source).",
    note: "Vegetable shortening is halal; 'shortening' with no source, or animal shortening, should be verified.",
    aliases: ["shortening", "vegetable shortening", "baking fat", "vegetable fat"],
    slug: "shortening",
    alternativeNames: ["Shortening", "Vegetable shortening", "Baking fat"],
    fn: "Fat (baking)",
    confidence: "medium",
    originType: "variable",
    originSummary: "Shortening is a solid fat for baking that can be made from vegetable oils (halal) or from animal fat including lard (haram) — so plain 'shortening' is treated as doubtful until the source is known.",
    description: "Shortening is a fat that is solid at room temperature, used to give pastries, biscuits and cakes a tender, crumbly texture. It is most often made from hydrogenated or blended vegetable oils, but can also be animal-derived.",
    manufacturingSummary: "Vegetable shortening is produced from plant oils (often hydrogenated or interesterified). Animal shortening can include lard or beef tallow. The label may simply say 'shortening' or 'vegetable/animal fat'.",
    halalReasoning: "The ruling depends entirely on the fat source. Vegetable shortening is halal. Animal shortening is halal only if from a halal-slaughtered permissible animal; lard-based shortening is haram. Because 'shortening' alone does not state the source, and emulsifiers used within it (such as mono- and diglycerides) can also be animal-derived, the honest default is to verify.",
    verificationAdvice: "Prefer products that say 'vegetable shortening' or 'vegetable fat'. If the label says only 'shortening' or 'animal fat', check with the manufacturer or choose a halal-certified product — and note any mono-/diglyceride emulsifiers (E471) in the blend.",
    commonUses: ["Pastry, biscuits, cookies and cakes", "Frying fats", "Icings and fillings", "Some breads and crackers"],
    labelNames: ["Shortening", "Vegetable shortening", "Vegetable fat", "Animal fat"],
    singaporeGuidance: "In Singapore, MUIS HalalSG-certified bakeries use halal fats. For uncertified or imported baked goods, verify that the shortening is vegetable-based (or halal-certified) rather than lard/animal-derived.",
    faqs: [
      { q: "Is shortening halal?", a: "It depends on the source. Vegetable shortening is halal; animal or lard-based shortening is not (unless from a halal-slaughtered animal). Plain 'shortening' should be verified." },
      { q: "Is vegetable shortening halal?", a: "Yes — vegetable shortening is plant-based and halal. Still check any emulsifiers (e.g. E471 mono-/diglycerides) in the blend if you want full certainty." },
      { q: "How do I know if shortening is from lard?", a: "The label should say 'vegetable' or 'animal' fat. If it only says 'shortening', ask the manufacturer or choose a halal-certified product." },
    ],
    relatedCodes: ["E471", "E570", "E475"],
    sources: [muisSource("Fats and oils and their sources are assessed during halal certification"), codexGsfa("Fats and oils — identity and uses")],
    lastReviewed: REVIEWED,
  },
  {
    code: "", name: "Whey", category: "Other", status: "mushbooh",
    origin: "Milk by-product from cheesemaking — doubtful because it may involve animal rennet.",
    note: "Whey made with microbial/vegetarian rennet, or halal-certified whey, is halal.",
    aliases: ["whey", "whey powder", "whey protein", "milk serum"],
    slug: "whey",
    alternativeNames: ["Whey", "Whey powder", "Whey protein", "Milk serum"],
    fn: "Dairy ingredient",
    confidence: "medium",
    originType: "variable",
    originSummary: "Whey is the liquid left over from cheesemaking. Milk itself is halal, but whey is treated as doubtful because the cheese it comes from may have been made with animal rennet.",
    description: "Whey is the watery portion of milk that separates from the curds during cheesemaking. Dried into whey powder or concentrated into whey protein, it is widely used in baked goods, chocolate, protein supplements and infant formula.",
    manufacturingSummary: "Milk is coagulated (usually with rennet) to make cheese; the remaining liquid whey is filtered, dried or concentrated. The rennet used to make the parent cheese may be microbial/plant (halal) or animal (source-dependent).",
    halalReasoning: "Milk is halal, so the concern with whey is indirect: it is a by-product of cheese, and if that cheese used non-halal animal rennet, scholars differ on the status of the resulting whey, so the cautious default is doubtful (mushbooh). Whey from cheese made with microbial/vegetarian rennet, or whey that is halal-certified, is halal.",
    verificationAdvice: "Look for halal-certified whey or products stating microbial/vegetarian rennet. For uncertified whey powder or whey protein, ask the manufacturer what rennet the source cheese used.",
    commonUses: ["Protein powders and supplements", "Chocolate and confectionery", "Baked goods and biscuits", "Infant formula and dairy drinks"],
    labelNames: ["Whey", "Whey powder", "Whey protein concentrate/isolate", "Milk serum"],
    singaporeGuidance: "In Singapore, choose MUIS HalalSG-certified whey products or supplements. For uncertified imported whey/protein, verify the rennet source of the parent cheese with the manufacturer.",
    faqs: [
      { q: "Is whey halal?", a: "Milk is halal, but whey is a cheesemaking by-product and may involve animal rennet, so it is treated as doubtful unless the rennet is microbial/vegetarian or the product is halal-certified." },
      { q: "Is whey protein halal?", a: "It can be — choose halal-certified whey protein, or products whose source cheese used microbial/vegetarian rennet. Uncertified whey protein should be verified." },
      { q: "Why is whey doubtful if milk is halal?", a: "Because whey comes from cheese, and the cheese may have been made with non-halal animal rennet. That indirect link is why scholars treat plain whey as doubtful." },
    ],
    relatedCodes: ["E441"],
    sources: [muisSource("Dairy by-products and the rennet used in their source cheese are assessed during certification"), codexGsfa("Whey and whey products — composition")],
    lastReviewed: REVIEWED,
  },
  {
    code: "", name: "Vanilla extract", category: "Other", status: "mushbooh",
    origin: "Flavouring often made by extracting vanilla in alcohol — doubtful; alcohol-free vanilla exists.",
    note: "Alcohol-free vanilla flavouring, vanilla powder or halal-certified vanilla is halal.",
    aliases: ["vanilla", "vanilla extract", "vanilla essence", "vanilla flavouring"],
    slug: "vanilla-extract",
    alternativeNames: ["Vanilla extract", "Vanilla essence", "Vanilla flavouring", "Natural vanilla flavour"],
    fn: "Flavouring",
    confidence: "medium",
    originType: "variable",
    originSummary: "Vanilla itself is a plant, but 'vanilla extract' is commonly made by steeping vanilla in ethanol, so scholars treat alcohol-based extract as doubtful. Alcohol-free vanilla flavourings and powders are halal.",
    description: "Vanilla flavour comes from the pods of the vanilla orchid. Standard 'vanilla extract' is legally required in some countries to contain alcohol as the carrier solvent, while 'vanilla flavouring', vanilla powder and some essences are alcohol-free.",
    manufacturingSummary: "Traditional extract is made by percolating chopped vanilla pods in a water-ethanol solution, leaving alcohol in the finished extract. Alcohol-free versions use glycerine, propylene glycol or a dry powder carrier instead.",
    halalReasoning: "The vanilla plant is halal; the concern is the ethanol carrier in standard extract. Scholars differ: many treat the small residual alcohol in a finished baked good as negligible, while others avoid alcohol-based extracts entirely — so the cautious classification is doubtful (mushbooh). Alcohol-free vanilla flavouring, vanilla powder and halal-certified vanilla remove the doubt.",
    verificationAdvice: "For strict avoidance, choose 'alcohol-free vanilla', vanilla powder, or halal-certified vanilla. Standard 'vanilla extract' lists alcohol as a carrier; check the label if this matters to you.",
    commonUses: ["Cakes, cookies and baked goods", "Ice cream and desserts", "Drinks and syrups", "Chocolate and confectionery"],
    labelNames: ["Vanilla extract", "Vanilla essence", "Natural vanilla flavour", "Alcohol-free vanilla"],
    singaporeGuidance: "In Singapore, MUIS HalalSG-certified products use approved (alcohol-free or within-tolerance) flavourings. For home baking or uncertified products, choose alcohol-free vanilla or vanilla powder if you prefer to avoid alcohol carriers.",
    faqs: [
      { q: "Is vanilla extract halal?", a: "The vanilla plant is halal, but standard extract is usually made with an ethanol carrier, so scholars treat alcohol-based extract as doubtful. Alcohol-free vanilla flavouring or powder, and halal-certified vanilla, are halal." },
      { q: "Is the alcohol in vanilla extract a problem?", a: "Scholars differ — some consider the trace alcohol in a baked good negligible, others avoid alcohol-based extracts entirely. For certainty, use alcohol-free vanilla or halal-certified products." },
      { q: "What is a halal alternative to vanilla extract?", a: "Alcohol-free vanilla flavouring, vanilla powder, or ground vanilla pods/seeds — and halal-certified vanilla products." },
    ],
    relatedCodes: [],
    sources: [muisSource("Flavourings and their alcohol carriers are assessed during halal certification"), codexGsfa("Flavouring preparations — composition and carriers")],
    lastReviewed: REVIEWED,
  },
];
