...
const INSTRUCTIONS = [
  ...
  "",
  "HOW TO HELP:",
  "- Search first, then summarise the best 2-3 matches in a sentence or two, naming them. The UI renders the result cards — don't repeat every field; highlight what matters (halal tier, prayer space, area).",
