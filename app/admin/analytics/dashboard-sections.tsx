...
export const S: Record<string, React.CSSProperties> = {
  ...
  header: {
    ...
    padding: "22px 24px",
    borderRadius: 22,
    background: "linear-gradient(135deg, #0D424A, #0F6E56)",
    color: "#fff",
    boxShadow: "0 18px 44px rgba(18,82,91,.18)",
  },
  backLink: {
    display: "inline-flex",
    alignItems: "center",
  ...
  tabOn: { fontSize: 13, padding: "9px 13px", border: "none", borderRadius: 12, background: "#fff", color: "#12525B", fontWeight: 800, cursor: "pointer", boxShadow: "0 4px 14px rgba(31,41,51,.08)" },
  ...
  csvBtn: { fontSize: 11, padding: "6px 11px", borderRadius: 999, border: "1px solid rgba(18,82,91,.25)", background: "#E1F5EE", color: "#0F6E56", cursor: "pointer", whiteSpace: "nowrap", fontWeight: 800 },
  ...
  heroStat: { background: "linear-gradient(135deg,#E1F5EE,#F7FBF8)", borderRadius: 14, padding: "0.9rem 1rem", marginBottom: 8, border: "1px solid rgba(18,82,91,.12)" },
  ...
  backBtn: { fontSize: 12, padding: "7px 12px", marginBottom: 10, borderRadius: 999, border: "1px solid rgba(18,82,91,.25)", background: "#E1F5EE", color: "#0F6E56", cursor: "pointer", fontWeight: 800 },
