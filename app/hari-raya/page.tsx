      ...
      <div className="screen-in hh-page">
        ...
        <div className="hh-wrap hh-section">
          ...
          <div className="hub-grid">
            ...
            <Link href="/halal/halal-catering-singapore" className="hub-link"><span>Hari Raya catering &amp; buffets</span><span className="hub-link-arr" aria-hidden="true">→</span></Link>
            <Link href="/halal/halal-fashion-singapore" className="hub-link"><span>Baju kurung &amp; modest fashion</span><span className="hub-link-arr" aria-hidden="true">→</span></Link>
            <Link href="/halal/halal-dessert-singapore" className="hub-link"><span>Raya cookies &amp; desserts</span><span className="hub-link-arr" aria-hidden="true">→</span></Link>
